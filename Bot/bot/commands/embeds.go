...
func EasyError(s *discordgo.Session, m *discordgo.MessageCreate, title string, data ...interface{}) {
	s.ChannelMessageSendEmbed(m.ChannelID, NewErrorEmbed(title, fmt.Sprint(data...)))
}
